...
export default function Home() {
  return (
    <main className="h-screen z-10 flex flex-col justify-center w-full bg-cover bg-white px-[10vmin] lg:px-[20vmin] bg-[url(/Home/Mobilebackground.png)] lg:bg-[url(/Home/Background.svg)]">
      ...
      <Link href="/dashboard" className="bg-[#3852ce] rounded-sm shadow-sm text-white text-[3.5vmin] transition-all hover:bg-[#3852ce]/80 p-[2vmin] max-w-[30vmin] mt-[5vmin]">Get Started</Link>
      {/* <a href="https://www.google.com/" className="bg-[#3852ce] rounded-sm shadow-sm text-white text-[3.5vmin] transition-all hover:bg-[#3852ce]/80 p-[2vmin] max-w-[30vmin] mt-[5vmin]">Get Started</a> */}
    </main>
  )
}
